    ...
    <nav class="navbar navbar-default navbar-fixed-top" id="scrollspy">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php">VANNIE BEAUTY</a>
        </div>
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li>
							<a href="about.php"><span class="glyphicon glyphicon-user"></span> Produk</a>
						</li>
						<li>
							<a href="pesanan.php"><span class="glyphicon glyphicon-info-sign"></span> Pesanan</a>
						</li>
            <li>
